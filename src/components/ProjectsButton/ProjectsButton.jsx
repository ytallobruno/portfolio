...
export default function ProjectsButton({ href, children, type = "secondary" }) {
  const buttonClass =
    type === "primary"
      ? "relative bg-gradient-to-r from-primary-400 to-secondary-600 text-white shadow-lg hover:shadow-xl overflow-hidden before:absolute before:inset-0 before:bg-black before:opacity-0 hover:before:opacity-20 before:transition-opacity before:duration-300"
